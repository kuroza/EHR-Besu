...
// // abi and bytecode generated from ehrsc.sol:
// // > solcjs --bin --abi simplestorage.sol
// const contractJsonPath = path.resolve(__dirname, '../','build','contracts','EHRSC.json');
// const contractJson = JSON.parse(fs.readFileSync(contractJsonPath));
// const contractAbi = contractJson.abi;
// const contractBinPath = path.resolve(__dirname, '../','build','contracts','EHRSC.bin');
